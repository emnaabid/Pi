...
class PanierController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $paniers = $em->getRepository('UserBundle:Panier')
    ...
    {
        $panier = new Panier();
        $form = $this->createForm('UserBundle\Form\PanierType', $panier);
    ...
    {
        $deleteForm = $this->createDeleteForm($panier);
        $editForm = $this->createForm('UserBundle\Form\PanierType', $panier);
